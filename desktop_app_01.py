...
#------------------------------
def calcular():
    messagebox.showinfo("Minicalculadora 2.0", "Hizo click en el boton calcular")
    ...
    ent = int(a.get()) // int(b.get())
    t_resultados.insert(INSERT, f"{a.get()} // {b.get()} = {ent}\n")


def borrar():
    messagebox.showinfo("Minicalculadora 2.0", "Los datos seran borrados...")
    a.set("")
    b.set("")
    t_resultados.delete("1.0", "end")

def salir():
    messagebox.showinfo("Minicalculadora 2.0", "La app se cerrara")
...
ventana_principal.title("Minicalculadora 2.0")
...
#logo de la app
#Label(frame_entrada, image=PhotoImage(file="img/logo_uis.png"), bg="white").place(x=11, y=40)
"""
logo = PhotoImage(file="img/logo_uis.png")
label_logo = Label(frame_entrada, image=logo, bg="white")
label_logo.place(x=11, y=40)
"""
#etiqueta titulo
...
t_resultados.config(bg="black", fg = "green", font=("Courier-B", 15))
